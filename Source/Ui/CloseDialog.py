...
class CloseDialog(wx.Dialog):
    ...
    def __init__(self, _parent, _setting):
        ...
        self.__close_setting_choices = {
            key: val for key, val in GlobalVars.CLOSE_SETTING.items() if key != GlobalVars.CLOSE_USER_SELECT
        }
        self.__InitUI()
    ...
    def __InitCloseSetting(self):
        ...
        close_setting_sizer.Add(close_setting_label, 0,
    ...
    def __InitPrompt(self):
        ...
        close_prompt_sizer.Add(
            close_prompt, 0, wx.ALIGN_CENTER | wx.ALL, border)
